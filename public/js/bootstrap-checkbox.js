            ...
            var template = 
            	'<span class="button-checkbox bootstrap-checkbox">' +
            		'<button type="button" class="btn clearfix'+additionalButtonStyle+'">' +
	                    ...
	                    '<span class="glyphicon '+this.options.checkedClass+'" style="display:none;"></span>' +
	                    '<span class="glyphicon '+this.options.uncheckedClass+'"></span>' +
	                    '<span class="glyphicon '+this.options.indeterminateClass+'" style="display:none;"></span>' +
